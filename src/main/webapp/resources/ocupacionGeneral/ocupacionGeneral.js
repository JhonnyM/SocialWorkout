...
angular.module('myApp.ocupacionGeneral', ['ngRoute', 'ui.grid', 'ui.grid.cellNav' , 'ui.bootstrap'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/ocupacionGeneral', {
    templateUrl: 'resources/ocupacionGeneral/ocupacionGeneral.html',
    controller: 'miOcupacionGeneralCtrl'
  });  
}])

.controller('miOcupacionGeneralCtrl', ['$scope','$http','$uibModal','$route' , function($scope,$http,$uibModal, $route) {

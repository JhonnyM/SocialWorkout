		...
		<header id="header" class="app-header navbar" role="menu">
			...
			<div class="navbar-header bg-dark">
				...
				<a href="#/" class="navbar-brand text-lt"> <span
					class="hidden-folded m-l-xs">SW</span>
				</a>
				<!-- / brand -->
			</div>
			<!-- / navbar header -->
				...
				<div class="navi-wrap">
					...
					<nav ui-nav class="navi clearfix">
						<ul class="nav">
							...
							<li ng-if="mostrarCliente"><a href class="auto"> <span
								...
								<ul class="nav nav-sub dk">
									...
									<li><a href="layout_app.html"> <span>Mis
												rutinas</span>
									</a></li>
								</ul></li>
							<li ng-if='mostrarCliente'><a href class="auto"> <span
								...
								<ul class="nav nav-sub dk">
									<li class="nav-sub-header"></li>
									<li><a href="layout_app.html"> <span>Datos
												generales</span>
									</a></li>
									<li><a href="layout_app.html"> <span>Historial
												de medidas</span>
									</a></li>
									<li><a href="layout_fullwidth.html"> <span>Historial
												de asistencia</span>
									</a></li>
								</ul></li>
							<li ng-if='false'><a href class="auto"> <span
									class="pull-right text-muted"> <i
										class="fa fa-fw fa-angle-right text"></i> <i
										class="fa fa-fw fa-angle-down text-active"></i>
								</span> <b class="badge bg-info pull-right">3</b> <i
									class="glyphicon glyphicon-th"></i> <span>Gestiones{{mostrarInstructor}}</span>
							</a>
								<ul class="nav nav-sub dk">
							...
							<li ng-if="mostrarInstructor"><a href class="auto"> <span
									class="pull-right text-muted"> <i
										class="fa fa-fw fa-angle-right text"></i> <i
										class="fa fa-fw fa-angle-down text-active"></i>

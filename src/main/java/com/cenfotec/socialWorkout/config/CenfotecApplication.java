...
@ComponentScan(basePackages = {"com.cenfotec.socialWorkout"})
@EnableAutoConfiguration

@EnableJpaRepositories("com.cenfotec.socialWorkout.repositories")
@EnableTransactionManagement
@EntityScan(basePackages = "com.cenfotec.socialWorkout.ejb")
